...
class BlogPostEdit extends StatefulWidget {
  ...
  @override
  _BlogPostEditState createState() => _BlogPostEditState();
}

class _BlogPostEditState extends State<BlogPostEdit> {
  ...
  uploadImageToStorage(PickedFile pickedFile) async {
    if (pickedFile != null) {
      ...
      Reference _reference = FirebaseStorage.instance
          ...
          .child('images/blogs/${Path.basename(pickedFile.path)}');
      await _reference
          .putData(
