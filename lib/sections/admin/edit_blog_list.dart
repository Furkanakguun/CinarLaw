...
import 'package:cinarlaw/models/blog_edit.dart';
...
class EditBlogsList extends StatefulWidget {
  const EditBlogsList({
    Key key,
  }) : super(key: key);

  @override
  _EditBlogsListState createState() => _EditBlogsListState();
}

class _EditBlogsListState extends State<EditBlogsList> {
  getStarredBlogPost() async {
    ...
    for (var item in snapshot.docs) {
      feedItems.add(Padding(
          padding: EdgeInsets.all(8), child: BlogEdit.fromDocument(item)));
    }
    return feedItems;
  }
